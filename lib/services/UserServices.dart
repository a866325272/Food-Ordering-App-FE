...
class UserServices {
  Future<ApiResponse> details(String userId) async {
    ...
    Uri url = Uri.parse('http://16.163.25.188:3000/userdetails');
    try {
      ...
      _apiResponse.ApiError = ApiError(error: "伺服器錯誤,請重試");
    }
    return _apiResponse;
  }
  ...
  Future<ApiResponse> login(String userName, String userPass) async {
    ApiResponse _apiResponse = new ApiResponse();
    Uri url = Uri.parse('http://16.163.25.188:3000/login');
  ...
  Future<ApiResponse> signup(
    ...
    int isAdmin = 0;
    ApiResponse _apiResponse = new ApiResponse();
    Uri url = Uri.parse('http://16.163.25.188:3000/login/newuser');
    try {
      final http.Response response = await http.post(
        url,
        headers: <String, String>{
...
//    int isAvailable= 0;
    ...
    Uri url = Uri.parse('http://16.163.25.188:3000/');
    try {
